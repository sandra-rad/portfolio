...
export class LightboxComponent
  ...
  @Input() options: any;
  @Input() cmpRef: any;
  @ViewChild('outerContainer', { static: false })
  ...
  constructor(
    ...
    library.addIcons(faInstagram, faYoutube, faFacebookF, faDownload);
  }
  ...
  private _onLoadImageSuccess(): void {
    ...
    imageHeight = naturalImageHeight = this._imageElem.nativeElement
      .naturalHeight;
